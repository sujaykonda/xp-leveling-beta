  ...
  if (message.startsWith(prefix)) {
    ...
    switch (command) {
      ...
      case "rank":
        ...
        ctx.fillText(
          "Needed XP: " +
            (100 * level * level - xp[guild.id][user.id]).toString(),
          canvas.width / 1.5,
          canvas.height / 1.9
        );
      ...
      case "clearall":
        if (member.hasPermission("ADMINISTRATOR")) {
          ...
          msg.reply("You do not have enough perms to run this command");
        }
        break;
      case "clear":
        if (member.hasPermission("ADMINISTRATOR")) {
